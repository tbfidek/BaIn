...
//
//     if(familytype.value === "1"){
//         postAccount(form.elements[5].value, form.elements[6].value, form.elements[4].value);
//     }
//
//     createRelations();
//
//   //document.location.href = "http://localhost:3000/views/main.html";
// }
async function registerAccount(){
    console.log(child_ids);
    if(child_counter === 0){
    ...
    postAccount(form.elements[2].value, form.elements[3].value, form.elements[4].value)
        ...
        .then((parent_id) => {
            // Set the response header to redirect the user to the login page
            const loginUrl = 'http://localhost:3000/login';
            const redirectStatus = 302; // Found (HTTP 302)
